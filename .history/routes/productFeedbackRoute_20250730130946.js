...
const { GetAllFeedbacks, getAllFeedBacksByProductId, getAllFeedBacksByUserId, deleteFeedbackByUserIdProductId, deleteFeedbackByUserId, deleteFeedbackByProductId } = require("../controllers/productFeedbackController");
