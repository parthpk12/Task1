...
const { GetAllFeedbacks, getAllFeedBacksByProductId, getAllFeedBacksByUserId, delete_FeedbackBy_UserIdProductId } = require("../controllers/productFeedbackController");
...
productFeedbackRouter.delete("/delete/:pid" , delete_FeedbackBy_UserIdProductId );
